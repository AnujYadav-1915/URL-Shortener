  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen">
      <div className="card w-full max-w-md flex flex-col gap-4">
        ...
        <input placeholder="Name" value={name} onChange={e => setName(e.target.value)} className="px-2 py-1 rounded text-black" />
        ...
        <button onClick={handleSignup} disabled={loading} className="bg-gradient-to-r from-purple-500 to-blue-500 neon px-4 py-2 rounded text-white font-bold">{loading ? 'Loading...' : 'Sign Up'}</button>
