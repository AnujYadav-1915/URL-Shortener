      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-8">
          <section className="card !p-8">
            <h2 className="text-xl font-bold font-heading mb-4">1. Data Collection</h2>
          ...
          <section className="card !p-8">
            <h2 className="text-xl font-bold font-heading mb-4">2. Use of Data</h2>
            <p className="text-sm text-[#a5a0c8] leading-relaxed">
          ...
          <section className="card !p-8">
            <h2 className="text-xl font-bold font-heading mb-4">3. Cookies</h2>
            <p className="text-sm text-[#a5a0c8] leading-relaxed">
